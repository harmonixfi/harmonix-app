...
import StableCoinOverview from './StableCoinOverview';
import StableCoinParameter from './StableCoinParameter';
import StableCoinSafetyAssurance from './StableCoinSafetyAssurance';

type StableCoinDetailProps = {
  weeklyApy: number;
  monthlyApy: number;
  apr: number;
...
const StableCoinDetail = (props: StableCoinDetailProps) => {
