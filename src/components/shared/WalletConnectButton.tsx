    ...
    <>
      {connectionStatus === 'connected' ? (
        <div className="relative">
          <button
            type="button"
            className="text-xs sm:text-sm text-white uppercase bg-white bg-opacity-10 rounded-3xl px-3 xl:px-6 py-2 lg:py-3 text-center hover:ring-2 hover:ring-gray-800"
