              ...
              message={
                <div>
                  <div className="flex justify-between text-sm text-rock-sub-body">
                    ...
                    <p className="text-rock-light-blue justify-self-end">{`${apy}%`}</p>
                  </div>
                  <p className="text-sm font-normal break-words mt-2">
                    Vault yield is calculated by annualizing weekly yield generated by the vault.
                    The weekly yield does not include any losses incurred by the vault
                  </p>
                </div>
              }
            >
