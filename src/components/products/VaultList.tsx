...
const VaultList = () => {
  ...
  return (
    <div className="relative z-30 grid grid-cols-1 md:grid-cols-3 gap-6 xl:gap-8 w-[90%] sm:w-3/5 md:w-5/6 lg:w-[calc(100%-24px)] xl:w-[90%] 2xl:w-3/4 3xl:w-[1350px] mx-auto mt-6 md:mt-16 xl:mt-24 mb-24 md:mb-32 xl:mb-48 px-6 sm:px-0">
      {isLoading
        ? [...Array(3)].map((_, index) => (
            <div
              key={index}
