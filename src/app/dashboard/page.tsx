  ...
  return (
    <div className="max-w-[90%] mx-auto">
      ...
      <div className="w-full flex flex-col items-center gap-6 pb-24">
        <h3 className="text-2xl sm:text-3xl xl:text-3xl 2xl:text-5xl font-bold uppercase mt-0 sm:mt-16 mb-8">
          Dashboard
        </h3>
        <div className="w-[90%] sm:w-3/5 md:w-3/4 lg:w-[90%] xl:w-4/5 2xl:w-3/4 3xl:w-[1050px] grid grid-cols-2 gap-8">
