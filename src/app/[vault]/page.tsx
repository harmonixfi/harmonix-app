      ...
      <div className="grid grid-cols-5 gap-20 my-24">
        <div className="col-span-3">
          ...
          <div className="flex flex-col gap-24 mt-48">
            ...
            <div className="flex flex-col gap-6">
              <h5 className="text-4xl font-normal uppercase">Free transparency</h5>
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-base font-light text-rock-gray">
                For your security, once you buy this token, you&apos;ll need to wait 15 minutes
                before selling. This helps keep your funds safe from flash loan and arbitrage
                attacks.
              </p>
            </div>
          </div>
